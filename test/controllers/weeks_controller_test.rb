...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { end_day: @week.end_day, start_day: @week.start_day, total_contributed: @week.total_contributed, total_used: @week.total_used }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { end_day: @week.end_day, start_day: @week.start_day, total_contributed: @week.total_contributed, total_used: @week.total_used }
    assert_redirected_to week_path(assigns(:week))
  end
